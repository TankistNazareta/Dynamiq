            ...
            <aside className={`header__sidebar ${needSideBar ? 'header__sidebar-active' : ''}`}>
                <nav className="header__nav header__sidebar-nav">
                    <ul className="header__list header__sidebar-list d-flex flex-column justify-content-between">
                        ...
                        <li className="header__item header__sidebar-item">Shop</li>
                        <hr className="header__sidebar-line" />
                        <li className="header__item header__sidebar-item">About</li>
                        <hr className="header__sidebar-line" />
                        <li className="header__item header__sidebar-item">Contact</li>
                    </ul>
                </nav>
            </aside>
        </header>
